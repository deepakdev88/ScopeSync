                    ...
                    <header className='w-full border-b border-white/6 bg-[#0d0e14]/40 backdrop-blur-md px-6 py-4 sticky top-0 z-40'>
                        <div className='max-w-7xl mx-auto flex flex-col gap-4 w-full'>
                            ...
                            <div className='flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 w-full'>
                                ...
                                {isAdmin && (
                                    <button onClick={copyToClipBoard} className='cursor-pointer inline-flex items-center gap-2 px-4 py-2 rounded-xl border border-white/8 bg-white/2 hover:bg-white/6 hover:border-white/15 text-xs font-semibold text-gray-200 transition-all duration-200'>
